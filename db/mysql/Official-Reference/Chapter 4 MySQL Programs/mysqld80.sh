...
gdb                                                          FALSE
general-log                                                  FALSE
general-log-file                                             /var/lib/mysql/36d77fd7995f.log
...
relay-log                                                    36d77fd7995f-relay-bin
relay-log-index                                              36d77fd7995f-relay-bin.index
...
slow-query-log-file                                          /var/lib/mysql/36d77fd7995f-slow.log
